import { PlansRow } from "@/types/types";
...
export function ComparePlans() {
  ...
  return (
    <MaxWidthWrapper>
      <HeaderSection
        label="Planos"
        title="Compare nossos planos para Websites"
        subtitle="Encontre o plano perfeito sob medida para as necessidades do seu negócio!"
      />
